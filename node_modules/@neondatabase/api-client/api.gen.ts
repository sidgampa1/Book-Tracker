...
export enum IdentitySupportedAuthProvider {
  Mock = 'mock',
  Stack = 'stack',
}
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  ...
  listProjectBranches = ({ projectId, ...query }: ListProjectBranchesParams, params: RequestParams = {}) =>
    this.request<BranchesResponse & AnnotationsMapResponse, GeneralError>({
      path: `/projects/${encodeURIComponent(projectId)}/branches`,
      method: 'GET',
      query: query,
      secure: true,
  ...
  listProjectVpcEndpoints = (projectId: string, params: RequestParams = {}) =>
    this.request<VPCEndpointsResponse, GeneralError>({
      path: `/projects/${encodeURIComponent(projectId)}/vpc-endpoints`,
      method: 'GET',
      secure: true,
      format: 'json',
      ...params,
  ...
  assignProjectVpcEndpoint = (
    ...
    this.request<void, GeneralError>({
      path: `/projects/${encodeURIComponent(projectId)}/vpc-endpoints/${encodeURIComponent(vpcEndpointId)}`,
      method: 'POST',
      body: data,
      secure: true,
      type: ContentType.Json,
  ...
  listOrganizationVpcEndpoints = (orgId: string, regionId: string, params: RequestParams = {}) =>
    this.request<VPCEndpointsResponse, GeneralError>({
      path: `/organizations/${encodeURIComponent(orgId)}/vpc/region/${encodeURIComponent(regionId)}/vpc-endpoints`,
      method: 'GET',
      secure: true,
      format: 'json',
      ...params,
  ...
  getOrganizationVpcEndpointDetails = (
    ...
    this.request<VPCEndpointDetails, GeneralError>({
      path: `/organizations/${encodeURIComponent(orgId)}/vpc/region/${encodeURIComponent(regionId)}/vpc-endpoints/${encodeURIComponent(vpcEndpointId)}`,
      method: 'GET',
      secure: true,
      format: 'json',
      ...params,
  ...
  transferProjectsFromUserToOrg = (data: TransferProjectsToOrganizationRequest, params: RequestParams = {}) =>
    this.request<
      EmptyResponse,
      (LimitsUnsatisfiedResponse | GeneralError) | ProjectsWithIntegrationResponse | GeneralError
    >({
