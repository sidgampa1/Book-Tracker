...
paths:
  ...
  /projects:
    get:
      ...
      parameters:
      - name: cursor
        description: Specify the cursor value from the previous response to retrieve
      ...
      - name: limit
        ...
        schema:
          ...
          maximum: 400
      - name: search
        description: Search by project `name` or `id`. You can specify partial `name`
          or `id` values to filter results.
        in: query
        schema:
          type: string
      - name: org_id
  ...
  /projects/{project_id}/permissions:
    ...
    get:
      ...
      description: Retrieves details about users who have access to the project, including
        the permission `id`, the granted-to email address, and the date project access
        was granted.
      tags:
      - Project
    ...
    post:
      ...
      description: Grants project access to the account associated with the specified
        email address
      tags:
      - Project
  ...
  /projects/{project_id}/permissions/{permission_id}:
    ...
    delete:
      ...
      description: Revokes project access from the user associted with the specified
        permisison `id`. You can retrieve a user's permission `id` by listing project
        access.
      tags:
      - Project
  ...
  /projects/{project_id}/connection_uri:
    get:
      ...
      - name: branch_id
        in: query
        description: The branch ID. Defaults to your project's default `branch_id`
          if not specified.
        required: false
        schema:
          type: string
      ...
      - name: endpoint_id
        in: query
        description: The endpoint ID. Defaults to the read-write `endpoint_id` associated
          with the `branch_id` if not specified.
        required: false
        schema:
          type: string
          pattern: "^[a-z0-9-]{1,60}$"
      ...
      - name: pooled
        in: query
        description: Adds the `-pooler` option to the connection URI when set to `true`,
          creating a pooled connection URI.
        required: false
        schema:
          type: boolean
      responses:
  ...
  /projects/{project_id}/branches:
    ...
    get:
      ...
      parameters:
      - name: search
        description: Search by branch `name` or `id`. You can specify partial `name`
          or `id` values to filter results.
        in: query
        schema:
          type: string
  ...
  /projects/{project_id}/branches/{branch_id}/restore:
    post:
      ...
      description: Restores a branch to an earlier state in its own or another branch's
        history
  ...
  /projects/{project_id}/branches/{branch_id}/schema:
    get:
      ...
      description: Retrieves the schema from the specified database. The `lsn` and
        `timestamp` values cannot be specified at the same time. If both are omitted,
        the database schema is retrieved from database's head.
  ...
  /projects/{project_id}/branches/{branch_id}/roles/{role_name}/reset_password:
    ...
    post:
      ...
      responses:
        ...
        default:
          $ref: "#/components/responses/GeneralError"
  /projects/{project_id}/vpc-endpoints:
    parameters:
    - name: project_id
      in: path
      description: The Neon project ID
    ...
    get:
      ...
      responses:
        200:
          description: The list of configured VPC endpoint restrictions for the specified
            project
          content:
            application/json:
              schema:
        ...
        default:
          $ref: "#/components/responses/GeneralError"
  /projects/{project_id}/vpc-endpoints/{vpc_endpoint_id}:
    parameters:
    - name: project_id
      in: path
      description: The Neon project ID
    ...
    post:
      ...
      responses:
        200:
          description: Configured the specified VPC endpoint as a restriction for
    ...
    delete:
      ...
      responses:
        200:
          description: Deleted the specified VPC endpoint restriction from the specified
            project
        default:
          $ref: "#/components/responses/GeneralError"
  ...
  /consumption_history/account:
    get:
      ...
      responses:
        ...
        403:
          description: This endpoint is not available. It is only supported for Scale
            and Business plan accounts.
          content:
            application/json:
              schema:
                $ref: "#/components/schemas/GeneralError"
    ...
    get:
      ...
      - name: cursor
        ...
        schema:
          type: string
      - name: limit
        description: Specify a value from 1 to 100 to limit number of projects in
          the response.
        in: query
        schema:
          type: integer
          ...
          content:
            application/json:
              schema:
                ...
                - $ref: "#/components/schemas/PaginationResponse"
        403:
          description: This endpoint is not available. It is only supported with Scale
            and Business plan accounts.
          content:
            application/json:
              schema:
  ...
  /organizations/{org_id}/invitations:
    ...
    post:
      ...
      responses:
        ...
        default:
          $ref: "#/components/responses/GeneralError"
  /organizations/{org_id}/vpc/region/{region_id}/vpc-endpoints:
    parameters:
    - name: org_id
      in: path
      description: The Neon organization ID
    ...
    get:
      ...
      responses:
        ...
        default:
          $ref: "#/components/responses/GeneralError"
  /organizations/{org_id}/vpc/region/{region_id}/vpc-endpoints/{vpc_endpoint_id}:
    parameters:
    - name: org_id
      in: path
      description: The Neon organization ID
  ...
  /users/me/projects/transfer:
    post:
      summary: Transfer projects from your personal account to a specified destination
        account
      description: |
      ...
      responses:
        200:
          description: Projects successfully transferred from personal account to
            organization
          content:
            application/json:
              schema:
                $ref: "#/components/schemas/EmptyResponse"
        406:
          description: Transfer failed - the organization has too many projects or
            its plan is incompatible with the source account. Reduce projects or upgrade
            the organization.
          content:
            application/json:
              schema:
                ...
                - $ref: "#/components/schemas/GeneralError"
        422:
          description: One or more of project ids provided is linked by Github or
            Vercel integration. Transferring integration projects is currently not
            supported
          content:
            application/json:
              schema:
  ...
  schemas:
    ...
    AddProjectJWKSRequest:
      ...
      properties:
        jwks_url:
          ...
          type: string
        provider_name:
          description: The name of the authentication provider (e.g., Clerk, Stytch,
            Auth0)
          type: string
        branch_id:
    ...
    BillingAccount:
      ...
      properties:
        ...
        quota_reset_at_last:
          ...
          format: date-time
        name:
          description: The full name of the individual or entity that owns the billing
            account. This name appears on invoices.
          type: string
        email:
          description: |
    ...
    RegionResponse:
      ...
      properties:
        ...
        geo_lat:
          type: string
          description: The geographical latitude (approximate) for the region. Empty
            if unknown.
        geo_long:
          type: string
          description: The geographical longitude (approximate) for the region. Empty
            if unknown.
      ...
      properties:
        ...
        project_ids:
          ...
          items:
            type: string
            pattern: "^[a-z0-9-]{1,60}$"
          description: The list of projects ids to transfer. Maximum of 400 project
            ids
    ...
    PgbouncerSettingsData:
      ...
      additionalProperties:
        type: string
    PgVersion:
      description: The major Postgres version number. Currently supported versions
        are `14`, `15`, `16`, and `17`.
      type: integer
      minimum: 14
      maximum: 17
